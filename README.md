...
- **Редактиране на артикули** (`/admin/products`) – изглежда като каталога за потребители; hover върху карта → Редактирай/Изтрий; диалози за добавяне и редакция (заглавие, описание, снимка)
